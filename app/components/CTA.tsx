          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 bg-white/30 border-2 rounded-md focus:ring-2 focus:ring-black focus:outline-none transition-colors ${error ? 'border-red-500' : 'border-transparent'
                  }`}
                disabled={isLoading}
              />
